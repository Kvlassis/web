  ...
  <div class="row">
    <div class="col-sm-12">  
		<form action='' method=post id=form3>
			Αριθμός Ατόμων στο μέρος: <input type=number id=num name=num>
			<input type=hidden name=idpoi value='<?php echo $_GET['idp'] ; ?>'>
			<button type=submit class='btn btn-primary'>Δήλωση Επίσκεψης</button>
